            ...
            <div>
                <Marquee pauseOnHover={true}>
                    <div className="text-center max-w-sm ml-12">
                        ...
                        <Button variant="" className="rounded-none mt-4 bg-transparent border border-[#a55e3f] text-[#000000] dark:text-[#C8CBD0] dark:border-[#C8CBD0] font-lato tracking-widest">See More</Button>
                    </div>
                    <div className="text-center max-w-sm ml-12">
                        <div className="avatar">
                            <div className="w-24 rounded-full">
